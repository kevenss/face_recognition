...
kevin_image = fr.load_image_file("kevin.jpg")
kevin_face_encoding = fr.face_econdings(kevin_image)[0]

known_face_encondings = [kevin_face_encoding]
known_face_names = ["Kevin"]
